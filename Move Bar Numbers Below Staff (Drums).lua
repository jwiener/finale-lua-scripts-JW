...
function plugindef()
   ...
   return "Move Measure Numbers to Drum Position", "Undo Move Measure Numbers to Drum Position", "Moves measure numbers to the JAWLine Music standard drum part position."
end
...
for k=measureregions.Count,1,-1 do
    ...
    region:SetStartHorizontalPosition(0,true)
